...
{
    public class MockStreamGeometry : IStreamGeometryImpl, ITransformedGeometryImpl
    {
        private MockStreamGeometryContext _context;

        public MockStreamGeometry()
        {
            Transform = Matrix.Identity;
            _context = new MockStreamGeometryContext();
        }

        public MockStreamGeometry(Matrix transform)
        {
            Transform = transform;
            _context = new MockStreamGeometryContext();
        }

        private MockStreamGeometry(Matrix transform, MockStreamGeometryContext context)
        {
            Transform = transform;
            _context = context;
        }
        ...
        {
            return new MockStreamGeometry(Transform);
        }
        ...
        {
            return new MockStreamGeometry(transform, _context);
        }
