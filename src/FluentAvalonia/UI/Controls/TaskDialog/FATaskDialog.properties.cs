...
[PseudoClasses(s_pcHosted, s_pcHidden, FASharedPseudoclasses.s_pcOpen)]
[PseudoClasses(FASharedPseudoclasses.s_pcHeader, s_pcSubheader, FASharedPseudoclasses.s_pcIcon, s_pcFooter, s_pcFooterAuto, s_pcExpanded)]
...
public partial class FATaskDialog
{
    /// <summary>
    /// Defines the <see cref="Title"/> property
    /// </summary>
    public static readonly StyledProperty<string> TitleProperty =
        AvaloniaProperty.Register<FATaskDialog, string>(nameof(Title));

    /// <summary>
    /// Defines the <see cref="Header"/> property
    /// </summary>
    public static readonly StyledProperty<string> HeaderProperty =
        AvaloniaProperty.Register<FATaskDialog, string>(nameof(Header));

    /// <summary>
    /// Defines the <see cref="SubHeader"/> property
    /// </summary>
    public static readonly StyledProperty<string> SubHeaderProperty =
        AvaloniaProperty.Register<FATaskDialog, string>(nameof(SubHeader));

    /// <summary>
    /// Defines the <see cref="IconSource"/> property
    /// </summary>
    public static readonly StyledProperty<FAIconSource> IconSourceProperty =
        AvaloniaProperty.Register<FATaskDialog, FAIconSource>(nameof(IconSource));
    ...
    /// </summary>
    public static readonly DirectProperty<FATaskDialog, IList<FATaskDialogCommand>> CommandsProperty =
        AvaloniaProperty.RegisterDirect<FATaskDialog, IList<FATaskDialogCommand>>(nameof(Commands),
            x => x.Commands, (x, v) => x.Commands = v);

    /// <summary>
    /// Defines the <see cref="FooterVisibility"/> property
    /// </summary>
    public static readonly StyledProperty<FATaskDialogFooterVisibility> FooterVisibilityProperty =
        AvaloniaProperty.Register<FATaskDialog, FATaskDialogFooterVisibility>(nameof(FooterVisibility));

    /// <summary>
    /// Defines the <see cref="IsFooterExpanded"/> property
    /// </summary>
    public static readonly StyledProperty<bool> IsFooterExpandedProperty =
        AvaloniaProperty.Register<FATaskDialog, bool>(nameof(IsFooterExpanded));

    /// <summary>
    /// Defines the <see cref="Footer"/> property
    /// </summary>
    public static readonly StyledProperty<object> FooterProperty =
        AvaloniaProperty.Register<FATaskDialog, object>(nameof(Footer));

    /// <summary>
    /// Defines the <see cref="FooterTemplate"/> property
    /// </summary>
    public static readonly StyledProperty<IDataTemplate> FooterTemplateProperty =
        AvaloniaProperty.Register<FATaskDialog, IDataTemplate>(nameof(FooterTemplate));

    /// <summary>
    /// Defines the <see cref="ShowProgressBar"/> property
    /// </summary>
    public static readonly StyledProperty<bool> ShowProgressBarProperty =
        AvaloniaProperty.Register<FATaskDialog, bool>(nameof(ShowProgressBar));

    /// <summary>
    /// Defines the <see cref="HeaderBackground"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush> HeaderBackgroundProperty =
        AvaloniaProperty.Register<FATaskDialog, IBrush>(nameof(HeaderBackground));

    /// <summary>
    /// Defines the <see cref="HeaderForeground"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush> HeaderForegroundProperty =
        AvaloniaProperty.Register<FATaskDialog, IBrush>(nameof(HeaderForeground));

    /// <summary>
    /// Defines the <see cref="IconForeground"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush> IconForegroundProperty =
        AvaloniaProperty.Register<FATaskDialog, IBrush>(nameof(IconForeground));
