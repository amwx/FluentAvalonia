...
[PseudoClasses(FASharedPseudoclasses.s_pcHeader)]
...
public partial class FANumberBox
{
    /// <summary>
    /// Defines the <see cref="AcceptsExpression"/> property
    /// </summary>
    public static readonly StyledProperty<bool> AcceptsExpressionProperty =
        AvaloniaProperty.Register<FANumberBox, bool>(nameof(AcceptsExpression));

    /// <summary>
    /// Defines the <see cref="Description"/> property
    /// </summary>
    public static readonly StyledProperty<string> DescriptionProperty =
        AvaloniaProperty.Register<FANumberBox, string>(nameof(Description));

    /// <summary>
    /// Defines the <see cref="Header"/> property
    /// </summary>
    public static readonly StyledProperty<object> HeaderProperty =
        HeaderedContentControl.HeaderProperty.AddOwner<FANumberBox>();

    /// <summary>
    /// Defines the <see cref="HeaderTemplate"/> property
    /// </summary>
    public static readonly StyledProperty<IDataTemplate> HeaderTemplateProperty =
        HeaderedContentControl.HeaderTemplateProperty.AddOwner<FANumberBox>();

    /// <summary>
    /// Defines the <see cref="IsWrapEnabled"/> property
    /// </summary>
    public static readonly StyledProperty<bool> IsWrapEnabledProperty =
        AvaloniaProperty.Register<FANumberBox, bool>(nameof(IsWrapEnabled));

    /// <summary>
    /// Defines the <see cref="LargeChange"/> property
    /// </summary>
    public static readonly StyledProperty<double> LargeChangeProperty =
        RangeBase.LargeChangeProperty.AddOwner<FANumberBox>();

    /// <summary>
    /// Defines the <see cref="Minimum"/> property
    /// </summary>
    public static readonly StyledProperty<double> MinimumProperty =
        RangeBase.MinimumProperty.AddOwner<FANumberBox>(
            new StyledPropertyMetadata<double>(
                defaultValue: double.MinValue,
                coerce: (ao, d1) =>
                {
                    var nb = ao as FANumberBox;
                    var max = nb.Maximum;
                    if (d1 > max)
                        d1 = max;
    ...
    public static readonly StyledProperty<double> MaximumProperty =
        RangeBase.MaximumProperty.AddOwner<FANumberBox>(
            new StyledPropertyMetadata<double>(
    ...
    public static readonly StyledProperty<IBrush> SelectionHighlightColorProperty =
        TextBox.SelectionBrushProperty.AddOwner<FANumberBox>();

    /// <summary>
    /// Defines the <see cref="SmallChange"/> property
    /// </summary>
    public static readonly StyledProperty<double> SmallChangeProperty =
        RangeBase.SmallChangeProperty.AddOwner<FANumberBox>();
    ...
    public static readonly StyledProperty<FANumberBoxValidationMode> ValidationModeProperty =
       AvaloniaProperty.Register<FANumberBox, FANumberBoxValidationMode>(nameof(ValidationMode));

    /// <summary>
    /// Defines the <see cref="Value"/> property
    /// </summary>
    public static readonly StyledProperty<double> ValueProperty =
         RangeBase.ValueProperty.AddOwner<FANumberBox>(
             new StyledPropertyMetadata<double>(
