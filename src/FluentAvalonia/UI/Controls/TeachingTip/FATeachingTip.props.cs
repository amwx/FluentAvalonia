...
[PseudoClasses(s_pcContent, FASharedPseudoclasses.s_pcIcon)]
...
public partial class FATeachingTip : ContentControl
{
    ...
    public static readonly StyledProperty<string> TitleProperty =
           AvaloniaProperty.Register<FATeachingTip, string>(nameof(Title));

    /// <summary>
    /// Defines the <see cref="Subtitle"/> property
    /// </summary>
    public static readonly StyledProperty<string> SubtitleProperty =
        AvaloniaProperty.Register<FATeachingTip, string>(nameof(Subtitle));

    /// <summary>
    /// Defines the <see cref="IsOpen"/> property
    /// </summary>
    public static readonly StyledProperty<bool> IsOpenProperty =
        FAInfoBar.IsOpenProperty.AddOwner<FATeachingTip>();

    /// <summary>
    /// Defines the <see cref="Target"/> property
    /// </summary>
    public static readonly StyledProperty<Control> TargetProperty =
        AvaloniaProperty.Register<FATeachingTip, Control>(nameof(Target));
    ...
    public static readonly StyledProperty<FATeachingTipTailVisibility> TailVisibilityProperty =
        AvaloniaProperty.Register<FATeachingTip, FATeachingTipTailVisibility>(nameof(TailVisibility));
    ...
    public static readonly StyledProperty<object> ActionButtonContentProperty =
        AvaloniaProperty.Register<FATeachingTip, object>(nameof(ActionButtonContent));
    ...
    public static readonly StyledProperty<ControlTheme> ActionButtonStyleProperty =
        AvaloniaProperty.Register<FATeachingTip, ControlTheme>(nameof(ActionButtonStyle));
    ...
    public static readonly StyledProperty<ICommand> ActionButtonCommandProperty =
        AvaloniaProperty.Register<FATeachingTip, ICommand>(nameof(ActionButtonCommand));
    ...
    public static readonly StyledProperty<object> ActionButtonCommandParameterProperty =
        AvaloniaProperty.Register<FATeachingTip, object>(nameof(ActionButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="CloseButtonContent"/> property
    /// </summary>
    public static readonly StyledProperty<object> CloseButtonContentProperty =
        AvaloniaProperty.Register<FATeachingTip, object>(nameof(CloseButtonContent));
    ...
    public static readonly StyledProperty<ControlTheme> CloseButtonStyleProperty =
        AvaloniaProperty.Register<FATeachingTip, ControlTheme>(nameof(CloseButtonStyle));
    ...
    public static readonly StyledProperty<ICommand> CloseButtonCommandProperty =
        AvaloniaProperty.Register<FATeachingTip, ICommand>(nameof(CloseButtonCommand));
    ...
    public static readonly StyledProperty<object> CloseButtonCommandParameterProperty =
        AvaloniaProperty.Register<FATeachingTip, object>(nameof(CloseButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="PlacementMargin"/> property
    /// </summary>
    public static readonly StyledProperty<Thickness> PlacementMarginProperty =
        AvaloniaProperty.Register<FATeachingTip, Thickness>(nameof(PlacementMargin));
    ...
    public static readonly StyledProperty<bool> ShouldConstrainToRootBoundsProperty =
        AvaloniaProperty.Register<FATeachingTip, bool>(nameof(ShouldConstrainToRootBounds));

    /// <summary>
    /// Defines the <see cref="IsLightDismissEnabled" /> property
    /// </summary>
    public static readonly StyledProperty<bool> IsLightDismissEnabledProperty =
        AvaloniaProperty.Register<FATeachingTip, bool>(nameof(IsLightDismissEnabled));
    ...
    public static readonly StyledProperty<FATeachingTipPlacementMode> PreferredPlacementProperty =
        AvaloniaProperty.Register<FATeachingTip, FATeachingTipPlacementMode>(nameof(PreferredPlacement));
    ...
    public static readonly StyledProperty<FATeachingTipHeroContentPlacementMode> HeroContentPlacementProperty =
        AvaloniaProperty.Register<FATeachingTip, FATeachingTipHeroContentPlacementMode>(nameof(HeroContentPlacement));

    /// <summary>
    /// Defines the <see cref="HeroContent"/> property
    /// </summary>
    public static readonly StyledProperty<Control> HeroContentProperty =
        AvaloniaProperty.Register<FATeachingTip, Control>(nameof(HeroContent));

    /// <summary>
    /// Defines the <see cref="IconSource"/> property
    /// </summary>
    public static readonly StyledProperty<FAIconSource> IconSourceProperty =
        FASettingsExpander.IconSourceProperty.AddOwner<FATeachingTip>();

    /// <summary>
    /// Defines the <see cref="TemplateSettings"/> property
    /// </summary>
    public static readonly StyledProperty<FATeachingTipTemplateSettings> TemplateSettingsProperty =
        AvaloniaProperty.Register<FATeachingTip, FATeachingTipTemplateSettings>(nameof(TemplateSettings));
