...
public partial class FATeachingTip : ContentControl
{
    ...
    protected override AutomationPeer OnCreateAutomationPeer() =>
        new FATeachingTipAutomationPeer(this);
    ...
    private void IsOpenChangedToOpen()
    {
        ...
        if (tipDoesNotFit)
        {
            ...
            var closedArgs = new FATeachingTipClosedEventArgs(_lastCloseReason);
    ...
    private void OnHeroContentPlacementChanged()
    {
        ...
        {
            case FATeachingTipHeroContentPlacementMode.Auto:
                break;
        ...
        ref Span<byte> priorityList)
    {
        ...
        priorityList[1] = (byte)FATeachingTipPlacementMode.Bottom;
        priorityList[2] = (byte)FATeachingTipPlacementMode.Left;
        priorityList[3] = (byte)FATeachingTipPlacementMode.Right;
        priorityList[4] = (byte)FATeachingTipPlacementMode.TopLeft;
        priorityList[5] = (byte)FATeachingTipPlacementMode.TopRight;
        priorityList[6] = (byte)FATeachingTipPlacementMode.BottomLeft;
        priorityList[7] = (byte)FATeachingTipPlacementMode.BottomRight;
        priorityList[8] = (byte)FATeachingTipPlacementMode.LeftTop;
        priorityList[9] = (byte)FATeachingTipPlacementMode.LeftBottom;
        priorityList[10] = (byte)FATeachingTipPlacementMode.RightTop;
        priorityList[11] = (byte)FATeachingTipPlacementMode.RightBottom;
        priorityList[12] = (byte)FATeachingTipPlacementMode.Center;
