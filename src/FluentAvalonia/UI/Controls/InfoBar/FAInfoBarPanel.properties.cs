...
public sealed partial class FAInfoBarPanel : Panel
{
    ...
    public static readonly StyledProperty<Thickness> HorizontalOrientationPaddingProperty =
        AvaloniaProperty.Register<FAInfoBarPanel, Thickness>(nameof(HorizontalOrientationPadding));
    ...
    public static readonly StyledProperty<Thickness> VerticalOrientationPaddingProperty =
        AvaloniaProperty.Register<FAInfoBarPanel, Thickness>(nameof(VerticalOrientationPadding));
    ...
    public static readonly AttachedProperty<Thickness> HorizontalOrientationMarginProperty =
        AvaloniaProperty.RegisterAttached<FAInfoBarPanel, Control, Thickness>("HorizontalOrientationMargin");
    ...
    public static readonly AttachedProperty<Thickness> VerticalOrientationMarginProperty =
        AvaloniaProperty.RegisterAttached<FAInfoBarPanel, Control, Thickness>("VerticalOrientationMargin");
