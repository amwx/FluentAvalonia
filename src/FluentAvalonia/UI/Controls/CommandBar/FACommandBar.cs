...
public partial class FACommandBar : ContentControl
{
    ...
    public FACommandBar()
    {
        ...
        PseudoClasses.Add(FASharedPseudoclasses.s_pcCompact);
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            var newVal = change.GetNewValue<FACommandBarDefaultLabelPosition>();
            PseudoClasses.Set(s_pcLabelRight, newVal == FACommandBarDefaultLabelPosition.Right);
            PseudoClasses.Set(s_pcLabelBottom, newVal == FACommandBarDefaultLabelPosition.Bottom);
            PseudoClasses.Set(s_pcLabelCollapsed, newVal == FACommandBarDefaultLabelPosition.Collapsed);
        }
        else if (change.Property == ClosedDisplayModeProperty)
        {
            var newVal = change.GetNewValue<FACommandBarClosedDisplayMode>();
            PseudoClasses.Set(FASharedPseudoclasses.s_pcCompact, newVal == FACommandBarClosedDisplayMode.Compact);
            PseudoClasses.Set(s_pcMinimal, newVal == FACommandBarClosedDisplayMode.Minimal);
            PseudoClasses.Set(s_pcHidden, newVal == FACommandBarClosedDisplayMode.Hidden);
        }
        else if (change.Property == ItemsAlignmentProperty)
        {
            var val = change.GetNewValue<FACommandBarItemsAlignment>();
            PseudoClasses.Set(":itemsRight", val == FACommandBarItemsAlignment.Right);
        }
    }
...
SetState:
    ...
    private void AttachItems()
    {
        ...
        {
            _overflowSeparator = new FACommandBarSeparator
            {
                IsVisible = false
            };
