...
[PseudoClasses(FASharedPseudoclasses.s_pcHidden, FASharedPseudoclasses.s_pcOpen)]
...
public partial class FAContentDialog
{
    /// <summary>
    ...
    public static readonly StyledProperty<ICommand> CloseButtonCommandProperty =
        AvaloniaProperty.Register<FAContentDialog, ICommand>(nameof(CloseButtonCommand));
    ...
    public static readonly StyledProperty<object> CloseButtonCommandParameterProperty =
        AvaloniaProperty.Register<FAContentDialog, object>(nameof(CloseButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="CloseButtonText"/> property
    /// </summary>
    public static readonly StyledProperty<string> CloseButtonTextProperty =
        AvaloniaProperty.Register<FAContentDialog, string>(nameof(CloseButtonText));
    ...
    public static readonly StyledProperty<FAContentDialogButton> DefaultButtonProperty =
        AvaloniaProperty.Register<FAContentDialog, FAContentDialogButton>(nameof(DefaultButton), FAContentDialogButton.None);
    ...
    public static readonly StyledProperty<bool> IsPrimaryButtonEnabledProperty =
        AvaloniaProperty.Register<FAContentDialog, bool>(nameof(IsPrimaryButtonEnabled), true);
    ...
    public static readonly StyledProperty<bool> IsSecondaryButtonEnabledProperty =
        AvaloniaProperty.Register<FAContentDialog, bool>(nameof(IsSecondaryButtonEnabled), true);
    ...
    public static readonly StyledProperty<ICommand> PrimaryButtonCommandProperty =
        AvaloniaProperty.Register<FAContentDialog, ICommand>(nameof(PrimaryButtonCommand));
    ...
    public static readonly StyledProperty<object> PrimaryButtonCommandParameterProperty =
        AvaloniaProperty.Register<FAContentDialog, object>(nameof(PrimaryButtonCommandParameter));

    /// <summary>
    /// Defines the <see cref="PrimaryButtonText"/> property
    /// </summary>
    public static readonly StyledProperty<string> PrimaryButtonTextProperty =
        AvaloniaProperty.Register<FAContentDialog, string>(nameof(PrimaryButtonText));
    ...
    public static readonly StyledProperty<ICommand> SecondaryButtonCommandProperty =
        AvaloniaProperty.Register<FAContentDialog, ICommand>(nameof(SecondaryButtonCommand));
    ...
    public static readonly StyledProperty<object> SecondaryButtonCommandParameterProperty =
        AvaloniaProperty.Register<FAContentDialog, object>(nameof(SecondaryButtonCommandParameter));
    ...
    public static readonly StyledProperty<string> SecondaryButtonTextProperty =
        AvaloniaProperty.Register<FAContentDialog, string>(nameof(SecondaryButtonText));

    /// <summary>
    /// Defines the <see cref="Title"/> property
    /// </summary>
    public static readonly StyledProperty<object> TitleProperty =
        AvaloniaProperty.Register<FAContentDialog, object>(nameof(Title), "");

    /// <summary>
    /// Defines the <see cref="TitleTemplate"/> property
    /// </summary>
    public static readonly StyledProperty<IDataTemplate> TitleTemplateProperty =
        AvaloniaProperty.Register<FAContentDialog, IDataTemplate>(nameof(TitleTemplate));

    /// <summary>
    /// Defines the <see cref="FullSizeDesired"/> property
    /// </summary>
    public static readonly StyledProperty<bool> FullSizeDesiredProperty =
        AvaloniaProperty.Register<FAContentDialog, bool>(nameof(FullSizeDesired));
