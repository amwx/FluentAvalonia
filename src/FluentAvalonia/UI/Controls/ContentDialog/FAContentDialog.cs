...
public partial class FAContentDialog : ContentControl, ICustomKeyboardNavigation
{
    ...
    protected override void OnKeyUp(KeyEventArgs e)
    {
        ...
        switch (e.Key)
        {
            ...
            case Key.Enter:
                ...
                if (defButton != FAContentDialogButton.None)
                {
                    switch (defButton)
                    {
    ...
    private void HideCore()
    {
        ...
        var args = new FAContentDialogClosingEventArgs(_result);
    ...
    internal void SetupDialog()
    {
        ...
        switch (DefaultButton)
        {
            case FAContentDialogButton.Primary:
                ...
                _primaryButton.Classes.Add(FASharedPseudoclasses.s_cAccent);
                _secondaryButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
                _closeButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
            ...
            case FAContentDialogButton.Secondary:
                ...
                _secondaryButton.Classes.Add(FASharedPseudoclasses.s_cAccent);
                _primaryButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
                _closeButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
            ...
            case FAContentDialogButton.Close:
                ...
                _closeButton.Classes.Add(FASharedPseudoclasses.s_cAccent);
                _primaryButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
                _secondaryButton.Classes.Remove(FASharedPseudoclasses.s_cAccent);
    ...
    private void OnButtonClick(object sender, RoutedEventArgs e)
    {
        ...
        var args = new FAContentDialogButtonClickEventArgs();
