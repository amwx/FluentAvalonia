...
/// </remarks>
public abstract class FANonVirtualizingLayout : FALayout
{
    /// <summary>
    ...
    /// </summary>
    protected internal abstract void InitializeForContextCore(FALayoutContext context);

    /// <summary>
    /// When overridden in a derived class, removes any state the layout previously stored on the UIElement container.
    /// </summary>
    protected internal abstract void UninitializeForContextCore(FALayoutContext context);

    /// <summary>
    /// Provides the behavior for the "Measure" pass of the layout cycle. Classes can override this method to define their own "Measure" pass behavior.
    /// </summary>
    protected internal abstract Size MeasureOverride(FANonVirtualizingLayoutContext context, Size availableSize);
    ...
    /// </summary>
    protected internal abstract Size ArrangeOverride(FANonVirtualizingLayoutContext context, Size availableSize);
}
