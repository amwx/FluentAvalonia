...
// enums are identical
public enum FAFlowLayoutLineAlignment
{
    Start,
    Center,
    End,
...
public class FAFlowLayout : FAVirtualizingLayout, IOrientationBasedMeasures, IFlowLayoutAlgorithmDelegates
{
    ...
    public static readonly StyledProperty<FAFlowLayoutLineAlignment> LineAlignmentProperty = 
        AvaloniaProperty.Register<FAFlowLayout, FAFlowLayoutLineAlignment>(nameof(LineAlignment), 
            defaultValue: FAFlowLayoutLineAlignment.Start);
    ...
    public static readonly StyledProperty<double> MinRowSpacingProperty = 
        AvaloniaProperty.Register<FAFlowLayout, double>(nameof(MinRowSpacing));

    public static readonly StyledProperty<Orientation> OrientationProperty =
        StackPanel.OrientationProperty.AddOwner<FAFlowLayout>();
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs args)
    {
        ...
        {
            _lineAlignment = (FlowLayoutAlgorithm.LineAlignment)args.GetNewValue<FAFlowLayoutLineAlignment>();
        }
    }
    ...
    FlowLayoutAlgorithm GetFlowAlgorithm(FAVirtualizingLayoutContext context) =>
    ...
    private double GetAverageLineInfo(Size availableSize, FAVirtualizingLayoutContext context,
        FlowLayoutState flowState, ref double avgCountInLine)
    {
        ...
        {
            var tmpElement = context.GetOrCreateElementAt(0, FAElementRealizationOptions.ForceCreate | FAElementRealizationOptions.SuppressAutoRecycle);
