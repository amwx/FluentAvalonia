...
/// <see cref="IFAElementFactory"/>'s <see cref="IFAElementFactory.GetElement(FAElementFactoryGetArgs)"/>
/// </summary>
public class FAElementFactoryGetArgs
{
    ...
    /// <see cref="IFAElementFactory.GetElement(FAElementFactoryGetArgs)"/>
    /// </summary>
