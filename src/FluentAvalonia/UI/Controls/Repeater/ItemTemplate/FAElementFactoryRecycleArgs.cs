...
/// <see cref="IFAElementFactory"/>'s <see cref="IFAElementFactory.RecycleElement(FAElementFactoryRecycleArgs)"/>
/// </summary>
public class FAElementFactoryRecycleArgs
{
    /// <summary>
    /// Gets or sets the <see cref="Control"/> object to recycle when calling
    /// <see cref="IFAElementFactory.RecycleElement(FAElementFactoryRecycleArgs)"/>
    /// </summary>
