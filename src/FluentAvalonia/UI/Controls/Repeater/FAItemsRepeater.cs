...
public partial class FAItemsRepeater : Panel
{
    public FAItemsRepeater()
    {
        ...
        SetCurrentValue(LayoutProperty, new FAStackLayout());
    ...
    {
        return new FAItemsRepeaterAutomationPeer(this);
    }
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs args)
    {
        ...
        {
            OnLayoutChanged(args.GetOldValue<FALayout>(), args.GetNewValue<FALayout>());
        }
    ...
    private void OnDataSourcePropertyChanged(FAItemsSourceView oldValue, FAItemsSourceView newValue)
    {
        ...
        if (GetEffectiveLayout() is FALayout l)
        {
            ...
            try
            {
                ...
                if (l is FAVirtualizingLayout vl)
                {
    ...
    private void EnsureDefaultLayoutState()
    {
        if (!_wasLayoutChangedCalled)
        {
            ...
            var layout = GetEffectiveLayout() as FAVirtualizingLayout;
            OnLayoutChanged(null, layout);
        }
    }
