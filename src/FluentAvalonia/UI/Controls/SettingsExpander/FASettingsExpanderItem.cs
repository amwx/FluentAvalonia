...
public partial class FASettingsExpanderItem : ContentControl, ICommandSource
{
    ...
    {
        var newIcon = args.GetNewValue<FAIconSource>();
        PseudoClasses.Set(FASharedPseudoclasses.s_pcIcon, newIcon != null);
    ...
    private void OnActionIconSourceChanged(AvaloniaPropertyChangedEventArgs args)
    {
        if (IsClickEnabled)
        {
            ...
            TemplateSettings.ActionIcon = FAIconHelpers.CreateFromUnknown(newIcon);
        }
    }
    ...
    private void OnIsClickEnabledChanged(AvaloniaPropertyChangedEventArgs args)
    {
        ...
        {
            TemplateSettings.ActionIcon = FAIconHelpers.CreateFromUnknown(actionIcon);
    ...
    private void OnFooterChanged(AvaloniaPropertyChangedEventArgs args)
    {
        ...
        PseudoClasses.Set(FASharedPseudoclasses.s_pcFooter, _hasFooter);
    }
