...
[TemplatePart(s_tpMenuItemsHost, typeof(FAItemsRepeater))]
[TemplatePart(s_tpTopNavMenuItemsHost, typeof(FAItemsRepeater))]
[TemplatePart(s_tpTopNavMenuItemsOverflowHost, typeof(FAItemsRepeater))]
[TemplatePart(s_tpTopNavOverflowButton, typeof(Button))]
[TemplatePart(s_tpFooterMenuItemsHost, typeof(FAItemsRepeater))]
[TemplatePart(s_tpTopFooterMenuItemsHost, typeof(FAItemsRepeater))]
...
public partial class FANavigationView : HeaderedContentControl
{
    ...
    public static readonly StyledProperty<bool> AlwaysShowHeaderProperty =
        AvaloniaProperty.Register<FANavigationView, bool>(nameof(AlwaysShowHeader), true);
    ...
    public static readonly StyledProperty<AutoCompleteBox> AutoCompleteBoxProperty =
        AvaloniaProperty.Register<FANavigationView, AutoCompleteBox>(nameof(AutoCompleteBox));
    ...
    public static readonly StyledProperty<double> CompactModeThresholdWidthProperty =
        AvaloniaProperty.Register<FANavigationView, double>(nameof(CompactModeThresholdWidth),
    ...
    public static readonly StyledProperty<double> CompactPaneLengthProperty =
        AvaloniaProperty.Register<FANavigationView, double>(nameof(CompactPaneLength),
    ...
    public static readonly StyledProperty<Control> ContentOverlayProperty =
        AvaloniaProperty.Register<FANavigationView, Control>(nameof(ContentOverlay));
    ...
    public static readonly DirectProperty<FANavigationView, FANavigationViewDisplayMode> DisplayModeProperty =
        AvaloniaProperty.RegisterDirect<FANavigationView, FANavigationViewDisplayMode>(nameof(DisplayMode),
            x => x.DisplayMode);
    ...
    public static readonly StyledProperty<double> ExpandedModeThresholdWidthProperty =
        AvaloniaProperty.Register<FANavigationView, double>(nameof(ExpandedModeThresholdWidth), 1008.0,
    ...
    public static readonly DirectProperty<FANavigationView, IList<object>> FooterMenuItemsProperty =
        AvaloniaProperty.RegisterDirect<FANavigationView, IList<object>>(nameof(FooterMenuItems),
            x => x.FooterMenuItems);
    ...
    public static readonly StyledProperty<bool> IsBackButtonVisibleProperty =
        AvaloniaProperty.Register<FANavigationView, bool>(nameof(IsBackButtonVisible));
    ...
    public static readonly StyledProperty<bool> IsPaneOpenProperty =
        SplitView.IsPaneOpenProperty.AddOwner<FANavigationView>(
    ...
    public static readonly StyledProperty<bool> IsPaneToggleButtonVisibleProperty =
        AvaloniaProperty.Register<FANavigationView, bool>(nameof(IsPaneToggleButtonVisible), true);
    ...
    public static readonly DirectProperty<FANavigationView, IList<object>> MenuItemsProperty =
        AvaloniaProperty.RegisterDirect<FANavigationView, IList<object>>(nameof(MenuItems),
            o => o.MenuItems);
    ...
    public static readonly StyledProperty<IEnumerable> MenuItemsSourceProperty =
        AvaloniaProperty.Register<FANavigationView, IEnumerable>(nameof(MenuItemsSource));
    ...
    public static readonly StyledProperty<IDataTemplate> MenuItemTemplateProperty =
        AvaloniaProperty.Register<FANavigationView, IDataTemplate>(nameof(MenuItemTemplate));
    ...
    public static readonly StyledProperty<double> OpenPaneLengthProperty =
        AvaloniaProperty.Register<FANavigationView, double>(nameof(OpenPaneLength),
    ...
    public static readonly StyledProperty<Control> PaneCustomContentProperty =
        AvaloniaProperty.Register<FANavigationView, Control>(nameof(PaneCustomContent));
    ...
    public static readonly StyledProperty<Control> PaneFooterProperty =
        AvaloniaProperty.Register<FANavigationView, Control>(nameof(PaneFooter));

    /// <summary>
    /// Defines the <see cref="PaneHeader"/> property
    /// </summary>
    public static readonly StyledProperty<Control> PaneHeaderProperty =
        AvaloniaProperty.Register<FANavigationView, Control>(nameof(PaneHeader));
    ...
    public static readonly StyledProperty<FANavigationViewTemplateSettings> TemplateSettingsProperty =
        AvaloniaProperty.Register<FANavigationView, FANavigationViewTemplateSettings>(nameof(TemplateSettings));
