...
namespace FluentAvaloniaSamples.ViewModels
{
	public class MenuFlyoutPageViewModel : ViewModelBase
	{
		...
		public string Header => DescriptionServiceProvider.Instance.GetInfo("MenuFlyout", "Header");

		public string DefaultXamlSource => DescriptionServiceProvider.Instance.GetInfo("MenuFlyout", "DefaultXamlSource");

		public string BindingXamlSource => DescriptionServiceProvider.Instance.GetInfo("MenuFlyout", "BindingXamlSource");
