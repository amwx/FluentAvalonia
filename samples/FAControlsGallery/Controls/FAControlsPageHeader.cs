...
public class FAControlsPageHeader : TemplatedControl
{
    public static readonly StyledProperty<string> ControlNameProperty =
        FAControlsPageBase.ControlNameProperty.AddOwner<FAControlsPageHeader>();

    public static readonly StyledProperty<string> ControlNamespaceProperty =
        FAControlsPageBase.ControlNamespaceProperty.AddOwner<FAControlsPageHeader>();

    public static readonly StyledProperty<Type> TargetTypeProperty =
        ControlExample.TargetTypeProperty.AddOwner<FAControlsPageHeader>();
